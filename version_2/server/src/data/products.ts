/**
 * Sellable SKUs we expose in the shop. Amounts are never duplicated here — they
 * always come from Stripe `Prices` referenced by `stripePriceId`.
 */
...
export const PRODUCTS: CatalogProduct[] = [
  {
    ...
    stripePriceId: 'price_1TUSXxAMh8Qjd7tsg0m3mVcu',
  },
  {
    id: 'daydream-cloud',
    name: 'Daydream Cloud',
  ...
  },
  {
    ...
    stripePriceId: 'price_1TVACaAMh8Qjd7tsgpRRRZ2b',
  },
]
